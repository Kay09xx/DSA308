...
public class controller {
    @FXML
    private TableView<Products>producTable;
    @FXML
    private TableColumn<Products,String>id;
    @FXML
    private TableColumn<Products,String>name;
    @FXML
    private TableColumn<Products,String>comment;
   @FXML
   private TableColumn<Products,Integer>quantity;
    @FXML
    private TableColumn<Products,Float>costPrice;
    @FXML
    private TableColumn<Products,Double>totalPrice;
    @FXML
    private TableColumn<Products,LocalDate>expiredDate;
    @FXML
    private TableColumn<Products,LocalDate>registeredDate;
    @FXML
    private TableColumn<Products, Button>delete;
